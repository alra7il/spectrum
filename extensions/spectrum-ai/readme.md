...
Contributions are welcome, and they are greatly appreciated! Get started by reading our [Contributing Guide](https://github.com/Kilo-Org/kilocode/blob/HEAD/CONTRIBUTING.md). Or join our [Discord](https://discord.gg/kilocode) to chat with the team and community.
